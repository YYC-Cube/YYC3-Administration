...
export class CodeActionsService {
      ...
      messages: [
        {
          role: 'system',
          content:
            'You are an expert programmer. Replace code according to instructions.',
        },
        {
          role: 'user',
          content: prompt,
      ...
      messages: [
        {
          role: 'system',
          content:
            'You are an expert code refactoring specialist. Improve code quality and maintainability.',
        },
        {
          role: 'user',
          content: prompt,
      ...
      messages: [
        {
          role: 'system',
          content:
            'You are an expert code optimizer. Optimize code for better performance and readability.',
        },
        {
          role: 'user',
          content: prompt,
      ...
      messages: [
        {
          role: 'system',
          content:
            'You are an expert code formatter. Format code according to best practices.',
        },
        {
          role: 'user',
          content: prompt,
      ...
      messages: [
        {
          role: 'system',
          content:
            'You are an expert technical writer. Generate clear and comprehensive documentation.',
        },
        {
          role: 'user',
          content: prompt,
  ...
  private parseOptimizationResponse(content: string): {
    ...
    const optimizedCodeMatch = content.match(
      /OPTIMIZED_CODE:\n```(?:\w+)?\n([\s\S]*?)\n```/,
    )
   ...
   * 添加到剪贴板历史
   */
  private async addToClipboardHistory(
    ...
    const history = JSON.parse(
      localStorage.getItem('clipboard-history') || '[]',
    )
      ...
      messages: [
        {
          role: 'system',
          content:
            'You are an expert document formatter. Format documents for readability and consistency.',
        },
        {
          role: 'user',
          content: prompt,
      ...
      messages: [
        {
          role: 'system',
          content:
            'You are an expert document converter. Convert documents between formats accurately.',
        },
        {
          role: 'user',
          content: prompt,
      ...
      messages: [
        {
          role: 'system',
          content:
            'You are an expert document summarizer. Create clear and concise summaries.',
        },
        {
          role: 'user',
          content: prompt,
      ...
      messages: [
        {
          role: 'system',
          content:
            'You are an expert translator. Translate text accurately while maintaining tone and context.',
        },
        {
          role: 'user',
          content: prompt,
      ...
      messages: [
        {
          role: 'system',
          content:
            'You are an expert writer. Rewrite text for clarity, conciseness, and impact.',
        },
        {
          role: 'user',
          content: prompt,
      ...
      messages: [
        {
          role: 'system',
          content:
            'You are an expert writer. Expand text with relevant details and examples.',
        },
        {
          role: 'user',
          content: prompt,
      ...
      messages: [
        {
          role: 'system',
          content:
            'You are an expert editor. Correct grammar, spelling, and punctuation errors.',
        },
        {
          role: 'user',
          content: prompt,
      ...
      messages: [
        {
          role: 'system',
          content:
            'You are an expert code educator. Explain code clearly and comprehensively.',
        },
        {
          role: 'user',
          content: prompt,
      ...
      messages: [
        {
          role: 'system',
          content:
            'You are an expert code commenter. Add clear and helpful comments to code.',
        },
        {
          role: 'user',
          content: prompt,
      ...
      messages: [
        {
          role: 'system',
          content:
            'You are an expert code reviewer. Identify bugs, security issues, and performance problems.',
        },
        {
          role: 'user',
          content: prompt,
