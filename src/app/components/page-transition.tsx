 ...
 */
export const PageTransition = memo(function PageTransition({ pageKey, children }: PageTransitionProps) {
  ...
  const animStyle: CSSProperties =
    phase === "enter"
      ? { animation: "page-enter 0.35s var(--spring-easing) both", willChange: "transform, opacity, filter" }
      : phase === "exit"
