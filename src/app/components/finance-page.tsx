          ...
          {vouchers.map((v, i) => (
            ...
            >
              <div
                ...
                style={{ background: `${v.statusColor}10`, border: `1px solid ${v.statusColor}20` }}
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span
                    ...
                    style={{
                      ...
                      color: v.statusColor,
                      border: `1px solid ${v.statusColor}20`,
                    }}
                  >
                    {v.status}
                  </span>
        ...
        <div className="space-y-2">
          {expenses.map((e, i) => (
            ...
            >
              <div
                className="w-9 h-9 rounded-lg flex items-center justify-center shrink-0"
                style={{ background: `${e.statusColor}10`, border: `1px solid ${e.statusColor}20` }}
              >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <span
                    className="text-[10px] px-1.5 py-0.5 rounded"
                    style={{
                      background: `${e.statusColor}10`,
                      color: e.statusColor,
                      border: `1px solid ${e.statusColor}20`,
                    }}
                  >
                    {e.status}
                  </span>
              ...
              >
                ...
                <div className="flex justify-between mt-1">
                  ...
                  <span
                    className="text-[10px]"
                    style={{
                      color: pct > 90 ? '#ef4444' : pct > 75 ? '#f59e0b' : 'rgba(255,255,255,0.2)',
                    }}
                  >
                    {pct}%
                  </span>
