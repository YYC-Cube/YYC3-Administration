import {
  Calendar, CheckCircle2, Download, Edit, Eye, FileText, Filter,
  Folder, Grid3x3, Image, List, Music, Search, Share2,
  Star, Tag, Trash2, Upload, Video,
} from "lucide-react";
              ...
              <NeonCard key={asset.id} className="p-4 group cursor-pointer transition-all">
                ...
                <div className="space-y-3">
                  <div className="flex items-start justify-between gap-2">
                    <h3 className="font-medium text-sm line-clamp-1" style={{ color: tc.textPrimary }}>
                      {asset.name}
                    </h3>
                    <div
            ...
            <table className="w-full">
              <thead>
                <tr style={{ borderBottom: `1px solid ${tc.borderSubtle}` }}>
                  ...
                  <th className="text-center py-3 px-4 text-sm font-medium" style={{ color: tc.textMuted }}>
                    使用次数
                  </th>
                ...
                {filteredAssets.map((asset, idx) => {
                  ...
                  return (
                    <tr
                      key={asset.id}
                      style={{
                        borderBottom: idx < filteredAssets.length - 1 ? `1px solid ${tc.borderSubtle}` : "none",
                      }}
                    >
                      ...
                      <td className="py-4 px-4 text-center font-medium" style={{ color: tc.primary }}>
                        {asset.usage}
                      </td>
                      <td className="py-4 px-4">
