    ...
    >
      <style>{`
        @keyframes neon-pulse {
          0%, 100% { 
            box-shadow: 0 0 ${finalConfig.spread}px ${finalConfig.color}${Math.round(finalConfig.intensity * 0.25).toString(16).padStart(2, '0')},
                        0 0 ${finalConfig.spread * 2}px ${finalConfig.color}${Math.round(finalConfig.intensity * 0.15).toString(16).padStart(2, '0')};
          }
          50% { 
            box-shadow: 0 0 ${finalConfig.spread * 1.5}px ${finalConfig.color}${Math.round(finalConfig.intensity * 0.35).toString(16).padStart(2, '0')},
                        0 0 ${finalConfig.spread * 3}px ${finalConfig.color}${Math.round(finalConfig.intensity * 0.2).toString(16).padStart(2, '0')};
          }
        }
      `}</style>
      {children}
...
export function MotionContainer({
  ...
  const config = motionConfig ? { ...DEFAULT_MOTION_CONFIG, ...motionConfig } : DEFAULT_MOTION_CONFIG;
