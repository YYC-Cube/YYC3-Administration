import {
  Activity, ArrowDown, Bot, ChevronDown, Clock,
  Cpu, Filter, Pause, Phone,
  Play, Search, Trash2, Users,
} from "lucide-react";
...
const filterOptions: Array<{ id: FilterType; labelKey: string; icon: typeof Users; color: string }> = [
...
function formatTimestamp(d: Date, t: (key: string, params?: Record<string, string | number>) => string): string {
  const now = Date.now();
...
export function ActivityLogPage() {
  ...
  return (
    <div className="h-full overflow-hidden flex flex-col" style={{ animation: "spring-in 0.4s var(--spring-easing) both" }}>
      {/* Header */}
      <div className="shrink-0 p-4 sm:p-6 pb-0">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span className="hidden sm:inline">{autoScroll ? t("log.realtime") : t("log.paused")}</span>
            </button>
            {/* Live indicator */}
            <div
            ...
            >
              <div
                ...
                style={{ boxShadow: "0 0 6px #00ffc8", animation: "neon-pulse 2s ease-in-out infinite" }}
              />
        ...
        {/* Stats Bar */}
        {showStats && (
          <div className="grid grid-cols-5 gap-2 mb-4" style={{ animation: "spring-in 0.3s var(--spring-easing) both" }}>
            {[
              ...
              >
                <p className="text-lg tabular-nums" style={{ color: s.color, textShadow: `0 0 8px ${s.color}40` }}>
                  {s.value}
                </p>
        ...
        {filtered.length === 0 ? (
          ...
          <div className="relative pl-8">
            ...
            <div
              ...
              style={{
                background: "linear-gradient(180deg, rgba(0,240,255,0.3), rgba(0,212,255,0.2), rgba(0,255,200,0.1), transparent)",
              }}
            />
              ...
              return (
                ...
                >
                  ...
                  <div
                    ...
                    onMouseLeave={(e) => {
                      e.currentTarget.style.borderColor = isNew ? `${act.color}25` : "rgba(255,255,255,0.03)";
