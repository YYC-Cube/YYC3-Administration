...
export const NAV_CATEGORIES: NavCategoryDef[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'apiDocs', labelKey: 'nav.apiDocs', icon: BookOpen, color: '#8b5cf6' },
    ],
  },
  {
    id: 'platform',
    ...
    items: [
      ...
      { id: 'settings', labelKey: 'nav.settings', icon: Settings, color: '#6b7280' },
      { id: 'profile', labelKey: 'nav.profile', icon: Users, color: '#00d4ff' },
    ],
  },
  {
    id: 'finance',
    labelKey: 'nav.cat.finance',
    icon: BarChart3,
    color: '#22c55e',
    items: [
      { id: 'finance', labelKey: 'nav.finance', icon: BarChart3, color: '#22c55e' },
      { id: 'salary', labelKey: 'nav.salary', icon: ClipboardList, color: '#3b82f6' },
    ],
  },
  {
    id: 'supplyChain',
    labelKey: 'nav.cat.supplyChain',
    icon: Truck,
    color: '#f97316',
    items: [
