import {
  Award, Bot, Check, Copy, Eye,
  EyeOff, LayoutDashboard, Megaphone, MessageSquare, Settings, TrendingUp, UserPlus, Users,
} from "lucide-react";
    ...
    <div className="h-full overflow-y-auto" style={{ scrollbarWidth: "none" }}>
      ...
      <div className="px-6 pb-5">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            { label: "粉丝总数", value: "12.8万", trend: "+3.2% 本月", trendUp: true, color: "#22c55e" },
            { label: "消息响应率", value: "98.5%", trend: "优秀", trendUp: true, color: "#3b82f6" },
            { label: "菜单点击率", value: "15.2%", trend: "+2.1%", trendUp: true, color: "#8b5cf6" },
      ...
      <div className="px-6 pb-8">
        ...
        {activeTab === "reply" && (
          <div className="space-y-4">
            {[
              { keyword: "价格", type: "text", content: "感谢咨询，请问您需要了解哪个产品的价格？", enabled: true },
              { keyword: "联系", type: "text", content: "您好！客服电话：400-123-4567", enabled: true },
