...
import type { PanelType } from '@/features/dev-workspace/panels'
...
} from '@/features/dev-workspace/panels'
import { useThemeColors } from '@/shared/hooks/use-theme-colors'
import { useSettingsStore } from '@/stores/useSettingsStore'

// Lazy-load Monaco Editor (~435KB) — only loaded when dev workspace is opened
const CodeEditor = lazy(() =>
  import('@/app/components/code-editor').then((m) => ({ default: m.CodeEditor })),
)
